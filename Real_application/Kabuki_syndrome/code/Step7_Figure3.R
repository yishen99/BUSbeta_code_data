...
umap_Y = umap(Y_preprocessed[, c(-J-1, -J-2)], min_dist = 1, spread = 3) $ layout
...
umap_plot_Y <- ggplot(plot_Y, aes(x = X1, y = X2, colour = group_label)) +
  geom_point(size = 3) +
  annotate("segment", x = -16, xend = 26, y = -10, yend = -10, 
           color = "white", 
           arrow = arrow(length = unit(0.25, "cm"), type = "closed")) +
  annotate("segment", x = -16, xend = -16, y = -10, yend = 12, 
           color = "white", 
           arrow = arrow(length = unit(0.25, "cm"), type = "closed")) +
  scale_color_manual(
    values = color_values,
  ...
  scale_x_break(c(-1, 5), scales = "fixed", space = 0) + 
...
ggsave("../figures/Figure3(a).png", umap_plot_Y, width=9, height=6)
...
umap_YBUSbeta = umap(YBUSbeta_proc[, c(-J-1, -J-2)], min_dist = 1, spread = 3) $ layout
...
umap_plot_YBUSbeta <- ggplot(plot_YBUSbeta, aes(x = X1, y = X2, colour = group_label)) +
  geom_point(size = 3) +
  annotate("segment", x = -9, xend = 10, y = -24, yend = -24, 
           color = "white", 
           arrow = arrow(length = unit(0.25, "cm"), type = "closed")) +
  annotate("segment", x = -9, xend = -9, y = -24, yend = 12, 
           color = "white", 
           arrow = arrow(length = unit(0.25, "cm"), type = "closed")) +
  scale_color_manual(
    values = color_values,
  ...
  scale_y_break(c(-15, -6), scales = "fixed", space = 0) +
  labs(x = NULL, y = NULL, color = NULL) + 
  theme_minimal(base_size = 12) +
  theme(
    panel.grid = element_blank(), 
...
ggsave("../figures/Figure3(c).png", umap_plot_YBUSbeta, width=9, height=6)
...
umap_YBUS = umap(YBUS_proc[, c(-J-1, -J-2)], min_dist = 1, spread = 3) $ layout
...
umap_plot_YBUS <- ggplot(plot_YBUS, aes(x = X1, y = X2, colour = group_label)) +
  geom_point(size = 3) +
  annotate("segment", x = -14, xend = 15, y = -9, yend = -9, 
           color = "white", 
           arrow = arrow(length = unit(0.25, "cm"), type = "closed")) +
  annotate("segment", x = -14, xend = -14, y = -9, yend = 16, 
           color = "white", 
           arrow = arrow(length = unit(0.25, "cm"), type = "closed")) +
  scale_color_manual(
    values = color_values,
...
ggsave("../figures/Figure3(d).png", umap_plot_YBUS, width=9, height=6)
...
umap_YCombat = umap(YCombat_proc[, c(-J-1, -J-2)], min_dist = 1, spread = 3) $ layout
...
umap_plot_YCombat <- ggplot(plot_YCombat, aes(x = X1, y = X2, colour = group_label)) +
  geom_point(size = 3) +
  annotate("segment", x = -9, xend = 10, y = -23, yend = -23, 
           color = "white", 
           arrow = arrow(length = unit(0.25, "cm"), type = "closed")) +
  annotate("segment", x = -9, xend = -9, y = -23, yend = 13, 
           color = "white", 
           arrow = arrow(length = unit(0.25, "cm"), type = "closed")) +
  scale_color_manual(
    values = color_values,
  ...
  scale_y_break(c(-16, -6), scales = "fixed", space = 0) +
  labs(x = NULL, y = NULL, color = NULL) +
  theme_minimal(base_size = 12) +
  theme(
    panel.grid = element_blank(),
...
ggsave("../figures/Figure3(e).png", umap_plot_YCombat, width=9, height=6)
...
umap_YBEclear = umap(YBEclear_proc[, c(-J-1, -J-2)], min_dist = 1, spread = 3) $ layout
...
umap_plot_YBEclear <- ggplot(plot_YBEclear, aes(x = X1, y = X2, colour = group_label)) +
  geom_point(size = 3) +
  annotate("segment", x = -18, xend = 20, y = -15, yend = -15, 
           color = "white", 
           arrow = arrow(length = unit(0.25, "cm"), type = "closed")) +
  annotate("segment", x = -18, xend = -18, y = -15, yend = 25, 
           color = "white", 
           arrow = arrow(length = unit(0.25, "cm"), type = "closed")) +
  scale_color_manual(
    values = color_values,
  ...
  scale_y_break(c(-1, 14), scales = "fixed", space = 0) +
  labs(x = NULL, y = NULL, color = NULL) +
  theme_minimal(base_size = 12) +
  theme(
    panel.grid = element_blank(),
...
ggsave("../figures/Figure3(f).png", umap_plot_YBEclear, width=9, height=6)
