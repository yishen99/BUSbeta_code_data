...
### Y by batch
png(filename="../figures/Figure2(c).png", width = 500, height = 300)
...
### Y_BUS
png(filename="../figures/Figure2(f).png", width = 500, height = 300)
...
### Y_ComBat
png(filename="../figures/Figure2(g).png", width = 500, height = 300)
...
### Y_BEclear
png(filename="../figures/Figure2(h).png", width = 500, height = 300)
