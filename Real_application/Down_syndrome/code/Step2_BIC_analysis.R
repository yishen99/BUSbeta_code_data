...
# BIC_rec = c(-5538.541, -8438.517, -3408.420, -2599.727, -5778.371, -3221.858, -3716.608,  1314.765, -1318.169,  1178.036)


## Save BIC plot
png(file="../figures/Figure4(b).png", width = 500, height = 400)
options(scipen = 999)
