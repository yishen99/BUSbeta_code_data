...
## Set seed for BUSbeta in simulation case III
seed = 84
set.seed(seed)
...
## BIC_rec = c(-46345.81, -280179.50, -266690.95, -393300.05, -411919.18, -366832.61, -352948.61, -340445.51, -326205.97, -313563.10)


## Save BIC plot
png(file="../figures/FigureS3(d).png", width = 460, height = 400)
options(scipen = 999)
