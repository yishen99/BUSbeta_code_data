...
## BIC_rec=c(-156588.1, -396783.5, -500438.9, -539912.4, -560041.2, -536794.4, -527822.4, -514383.3, -500989.1, -487592.8)


## Save BIC plot
png(file="../figures/Figure2(d).png", width = 460, height = 400)
options(scipen = 999)
